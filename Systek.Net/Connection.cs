...
namespace Systek.Net
{
    ...
    public class Connection : IConnection
    {
        ...
        /// <returns>
        /// The reply <see cref="Systek.Net.Message" />.  <see cref="Systek.Net.Message.Type" /> will
        /// be set to TIMEOUT is the message has timed out, or FAIL if the send function threw an exception.
        /// </returns>
